/*
  Based on https://www.arduino.cc/en/Tutorial/DueSimpleWaveformGenerator
*/

/*
  Simple Waveform generator with Synapse Shield
  * connect a 10 kilohm potentiometer to A2 to control the signal frequency
 */
...
static int waveformsTable[maxWaveform][maxSamplesNum] = {
  ...
  // Square wave
  {
    0x800, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff,
    0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff,
    0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff,
    0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff,
    0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff,
    0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0xfff, 0x800,
    0x800, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000,
    0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000,
    0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000,
    0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000,
    0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000,
    0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x800
  }
...
void loop() {
  ...
  // Read the the potentiometer and map the value  between the maximum and the minimum
  // sample available
  ...
  sample = map(pot, 0, 4095, 0, oneHzSample);
  sample = constrain(sample, 0, oneHzSample);

  SynapseShield.writeCV(Synapse::CVChannel::A, waveformsTable[wave0][i]);
  SynapseShield.writeCV(Synapse::CVChannel::B, waveformsTable[wave1][i]);
